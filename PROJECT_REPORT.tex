...
% Define emoji replacements for better compatibility
\newunicodechar{🌳}{\textbf{[Tree]}}
\newunicodechar{🦠}{\textbf{[Virus]}}
\newunicodechar{🚗}{\textbf{[Car]}}
\newunicodechar{📡}{\textbf{[Signal]}}
\newunicodechar{⚡}{\textbf{[Lightning]}}
\newunicodechar{★}{\textbf{*}}
...
% Define block characters for progress bar
\newcommand{\textblock}{\rule{0.5em}{0.8em}}
\newcommand{\textlightblock}{\rule{0.5em}{0.1em}}
...
The system produces richly formatted, color-coded output with Unicode box-drawing characters and visual indicators:

\begin{lstlisting}[basicstyle=\ttfamily\footnotesize]
╔════════════════════════════════════════════════════════════╗
║           V 2 V   S I M U L A T I O N                     ║
║         Vehicle-to-Vehicle Network Analyzer               ║
╚════════════════════════════════════════════════════════════╝

Progress: [████████████████████████████████████████] 100% | T=60/60 | 🦠 45
...
▸ Cluster 1 (Root: ID 370)
  Members: { 404 745 170 669 933 299 ... }

▸ Cluster 2 (Root: ID 523)
  Members: { 523 997 37 536 331 538 ... }
...
╚═══════════════════════════════════════════════════════════╝
        ...
        404━⬤━745  404━⬤━170  233━⬤━669
        523━⬤━997  745━⬤━933  170━⬤━299
        ...

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📊 Network Statistics: 49 backbone connections established
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
This vehicle is the most connected hub in the network.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

╔═══════════════════════════════════════════════════════════╗
║         GRAPH ANALYSIS: OPTIMAL PATH                     ║
╚═══════════════════════════════════════════════════════════╝
...
\begin{itemize}
    \item \textbf{Rich Terminal Output:} ANSI color codes for enhanced readability (cyan, green, yellow, red, magenta)
    \item \textbf{Unicode Graphics:} Box-drawing characters (╔═╗ ║ ╚═╝ ━) and emojis (🌳 🦠 🚗 📡 ⚡ ★ 📊) for visual appeal
    \item \textbf{Progress Indicators:} Real-time animated progress bars showing simulation advancement
    \item \textbf{Interactive Menu:} User-friendly menu system allowing step-by-step analysis
    \item \textbf{Visual Tree Structure:} MST backbone displayed as tree with connection symbols (━⬤━)
    \item \textbf{Formatted Paths:} Dijkstra paths shown with directional arrows (←) for clarity
    \item \textbf{Status Dashboard:} Real-time statistics display with infection counts and network metrics
\end{itemize}
